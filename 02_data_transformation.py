...
# NOTE: Equipment_ID_Primary → Ekipman_ID (keep for internal script compatibility)
# The ID consistency fix is handled downstream via backward compatibility checks
rename_dict = {
    'Equipment_ID_Primary': 'Ekipman_ID',  # PHASE 1.1: Keep Ekipman_ID for internal compatibility
