@echo off
REM ============================================================================
REM WALK-FORWARD TEMPORAL VALIDATION
REM Turkish EDAŞ PoF Prediction Project
REM
REM Purpose:
REM   - Generate multiple training windows with proper temporal cutoffs
REM   - Prevent temporal leakage in model validation
REM   - Enable walk-forward validation for production readiness
REM
REM Usage:
REM   run_temporal_windows.bat
REM
REM Output:
REM   - data\equipment_level_data_temporal_window1_2023.csv
REM   - data\equipment_level_data_temporal_window2_2024Q1.csv
REM   - data\equipment_level_data_temporal_window3_2024Q2.csv
REM   - (+ metadata and documentation files)
REM
REM Author: Data Analytics Team
REM Date: 2025-11-17
REM ============================================================================
...
if not exist "02_data_transformation_temporal.py" (
...
if not exist "data\combined_data.xlsx" (
...
REM ============================================================================
REM WINDOW 1: 2023-06-25 (Historical Validation)
REM ============================================================================
echo ================================================================================
...
python 02_data_transformation_temporal.py --cutoff_date 2023-06-25 --prediction_horizon 365 --output_suffix "_window1_2023"
...
REM ============================================================================
REM WINDOW 2: 2024-01-01 (Recent Validation)
REM ============================================================================
echo ================================================================================
...
python 02_data_transformation_temporal.py --cutoff_date 2024-01-01 --prediction_horizon 365 --output_suffix "_window2_2024Q1"
...
REM ============================================================================
REM WINDOW 3: 2024-06-25 (Production Deployment)
REM ============================================================================
echo ================================================================================
...
python 02_data_transformation_temporal.py --cutoff_date 2024-06-25 --prediction_horizon 365 --output_suffix "_window3_2024Q2"
